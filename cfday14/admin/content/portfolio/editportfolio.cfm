		...
		<div class="span10">
			...
			<form class="form-horizontal" action="#cgi.script_name#" method="post" enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="3" id="summary" name="summary" style="width:80%; height:15%;">#form.summary#</textarea>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<cfif val(url.id) >
					</br><img src="../../../assets/images/portfolio/#qPortfolio.image#"   alt=" " border="0" />
					</cfif>		
