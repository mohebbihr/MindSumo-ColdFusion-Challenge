<cfparam name="form.eduid" default="" />
<cfparam name="form.schtitle" default="" />
<cfparam name="form.schstartDate" default="" />
<cfparam name="form.schendDate" default="" />
<cfparam name="form.schdetails" default="" />
...
<cfscript>
  idArray = ListToArray(form.eduid);
  titleArray = ListToArray(form.schtitle);
  stDateArray = ListToArray(form.schstartDate);
  enDateArray = ListToArray(form.schendDate);
  detailArray = ListToArray(form.schdetails);
	...
	<cfif idArray[i] eq 0>
		<cfquery>
			INSERT INTO
				...
				<cfqueryparam value="Education" cfsqltype="cf_sql_varchar" />
			)
		</cfquery>
